-- Schema for formulario_aluno
-- MySQL 5.7+/8.0+, UTF8MB4, InnoDB

SET NAMES utf8mb4;
SET time_zone = '+00:00';

CREATE DATABASE IF NOT EXISTS `formulario_aluno`
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;
USE `formulario_aluno`;

-- Tabela principal: submissões do formulário
CREATE TABLE IF NOT EXISTS `submissions` (
  ...
  KEY `idx_escola` (`escola`),
  KEY `idx_nome` (`nome`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Tabela de atividades (catálogo)
...
-- Respostas das atividades por submissão
CREATE TABLE IF NOT EXISTS `submission_activity_responses` (
  `submission_id` BIGINT UNSIGNED NOT NULL,
  `activity_id` INT UNSIGNED NOT NULL,
  `resposta` ENUM('Observou','Realizou Com Auxílio','Realizou Sem Auxílio') NULL,
  PRIMARY KEY (`submission_id`, `activity_id`),
  CONSTRAINT `fk_sar_submission` FOREIGN KEY (`submission_id`) REFERENCES `submissions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_sar_activity` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Popular a tabela de atividades com a lista usada no formulário
INSERT INTO `activities` (`titulo`) VALUES
